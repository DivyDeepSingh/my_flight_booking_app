...
import 'package:my_flight_booking_app/use_case/time_formatter.dart';
import 'package:my_flight_booking_app/utils/color_manager.dart';

class ChatScreen extends StatelessWidget {
  final GroupModel groupModel;
  ChatScreen({super.key, required this.groupModel});
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      GroupDetailsScreen(groupModel: groupModel),
                ),
              );
            },
          ),
